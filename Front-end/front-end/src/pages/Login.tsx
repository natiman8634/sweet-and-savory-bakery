    ...
    <div className="min-h-screen flex items-center justify-center bg-amber-50/50 px-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl text-amber-800">Welcome Back!</CardTitle>
          <CardDescription>Sign in to your Sweet & Savory Bakery account</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                name="email"
                render={({ field }) => (  // ✅ field is automatically typed
                  <FormItem>
