...
import { _ as isShadowRoot, f as isElement, g as isOverflowElement, h as isNode, l as getParentNode, m as isLastTraversableNode, n as getComputedStyle, o as getNodeName, p as isHTMLElement, u as getWindow } from "./error-p7Ej-3hV.js";
import { t as ownerDocument } from "./owner-BDq0SB0M.js";
import { r as useIsoLayoutEffect, t as useStableCallback } from "./useStableCallback-PzukGbE9.js";
import { c as useRefWithInit, i as useMergedRefs, o as EMPTY_OBJECT, r as isReactVersionAtLeast, s as NOOP, t as useRenderElement } from "./useRenderElement-CsdWguk4.js";
import { a as useTransitionStatus, c as useAnimationFrame, o as resolveRef, r as TransitionStatusDataAttributes, s as AnimationFrame, t as useOpenChangeComplete } from "./useOpenChangeComplete-VgXhcyuA.js";
import { n as useTimeout, t as Timeout } from "./useTimeout-Xzfdy2HM.js";
import { n as contains, r as getTarget, t as activeElement } from "./shadowDom-DDiirZu8.js";
import { a as focusOut, i as escapeKey, l as none, m as triggerPress, t as createChangeEventDetails, u as outsidePress } from "./createBaseUIEventDetails-Dietsjks.js";
import { t as visuallyHidden } from "./visuallyHidden-DhkJ3tLx.js";
import { b as isElementVisible, t as useValueChanged } from "./useValueChanged-CjtQxvh2.js";
import { n as useId } from "./useBaseUiId-B1OxdE7Y.js";
...
//#endregion
export { mergeCleanups as $, useDismiss as A, CLICK_TRIGGER_IDENTIFIER as B, FloatingRootStore as C, fastComponent as D, useStore as E, useFloatingNodeId as F, createAttribute as G, DROPDOWN_COLLISION_AVOIDANCE as H, useFloatingParentNodeId as I, getTabbableAfterElement as J, getNodeChildren as K, useFloatingTree as L, FloatingFocusManager as M, FloatingNode as N, fastComponentRef as O, FloatingTree as P, useValueAsRef as Q, FloatingTreeStore as R, useSyncedFloatingRootContext as S, Store as T, POPUP_COLLISION_AVOIDANCE as U, DISABLED_TRANSITIONS_STYLE as V, enqueueFocus as W, isOutsideEvent as X, getTabbableBeforeElement as Y, FocusGuard as Z, usePopupInteractionProps as _, mac as _t, CommonPopupDataAttributes as a, matchesFocusVisible as at, useTriggerDataForwarding as b, triggerOpenStateMapping as c, ARROW_RIGHT as ct, attachPreventUnmountOnClose as d, isVirtualClick as dt, getFloatingFocusElement as et, createDefaultInitialFocus as f, isVirtualPointerEvent as ft, useOpenStateTransitions as g, webkit as gt, useInitialOpenSync as h, jsdom as ht, inertValue as i, isTypeableElement as it, useClick as j, createSelector as k, PopupTriggerMap as l, ARROW_UP as lt, useImplicitActiveTrigger as m, useScrollLock as mt, useOpenMethodTriggerProps as n, isTargetInsideEnabledTrigger as nt, popupStateMapping as o, ARROW_DOWN as ot, setPopupOpenState as p, stopEvent as pt, getNextTabbable as q, InternalBackdrop as r, isTypeableCombobox as rt, pressableTriggerOpenStateMapping as s, ARROW_LEFT as st, useOpenInteractionType as t, isInteractiveElement as tt, FOCUSABLE_POPUP_PROPS as u, isMouseLikePointerType as ut, usePopupRootSync as v, addEventListener as vt, ReactStore as w, useTriggerRegistration as x, usePopupStore as y, useOnFirstRender as yt, FloatingPortal as z };
